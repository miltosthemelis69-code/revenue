  ...
  return (
    <>
      <div style={{ marginBottom: 18 }}>
        <h2 className="serif" style={{ fontSize: 20, fontWeight: 400, margin: "0 0 6px" }}>Auto-captured clicks</h2>
      ...
      <div className="panel" style={{ padding: "18px 20px" }}>
        <div style={cardTitleStyle()}>Top clicks</div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 90px 90px 80px 70px", gap: 8, fontSize: 11, color: theme.faint, padding: "0 4px 8px", borderBottom: `1px solid ${theme.lineFaint}` }}>
          <span>Element</span>
        ...
        {AUTO_CLICKS.map((click, idx) => (
          ...
          >
            <div>
              ...
              <div className="mono" style={{ fontSize: 11, color: theme.faint, marginTop: 2 }}>{click.selector}</div>
            ...
            <div className="mono" style={{ fontSize: 12.5, textAlign: "right", color: click.conversionToSale > 20 ? theme.credit : theme.muted }}>
